---
name: code-reviewer
# Decision: Keep canonical name `code-reviewer`; coexistence with `/superpowers:*` skills is namespace-safe, and superpowers also ships an agent with the same purpose.
...
<!-- Claude port note: Prompt text includes OpenCode-specific references (hooks availability and post-review actions). Kept verbatim per porting requirements. -->
