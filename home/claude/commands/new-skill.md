---
description: Scaffold a new skill in the Obsidian vault
...
- Remind them to fill in the `description` field — Claude Code reads this to decide when to load the skill
