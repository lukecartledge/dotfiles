---
description: Save current session summary to the Obsidian vault
argument-hint: session topic or title
---
...
- Review the conversation for any skills that were loaded (via `/tdd`, `/verify`, or explicit skill loading).
